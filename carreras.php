                  ...
                  <div class="col-md-12">
                    ...
                    <form id="contact" action="" method="post">
                      <div class="row">
                        <div class="col-md-6">
                          <fieldset>
                            <input name="nombre" type="text" class="form-control" id="nombre" onkeypress="return soloLetras(event)"  placeholder="Cual es el nombre..." required="required">
                          </fieldset>
                        </div>
                        <div class="col-md-6">
                          <fieldset>
                              <input name="duracion" type="id_products" class="form-control" id="duracion" onkeypress="return valideKey(event);" placeholder="Duracion..."  id="id_products" required="required">
                          </fieldset>
                        </div>
                        <div class="col-md-12">
